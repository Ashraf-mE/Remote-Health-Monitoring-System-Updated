// USING POLLING (NOT USING WEBSOCKETS)
...
app.use(cors({
    origin: (origin, callback) => {
        if (!origin || origin.startsWith('http://192.168.188.')) {
...
app.get('/mcuData', async (req, res) => {
    ...
    try
    {
        ...
        const newsensorData = new sensorData({
            ...
            ecg: {            // The ECG values
                ecg1: sensorData_rec.ecg['ecg1'] || 0,
                ecg2: sensorData_rec.ecg['ecg2'] || 0,
                ecg3: sensorData_rec.ecg['ecg3'] || 0
            }
        });
